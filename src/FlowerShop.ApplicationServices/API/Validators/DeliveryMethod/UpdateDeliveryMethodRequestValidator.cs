...
public class UpdateDeliveryMethodRequestValidator : AbstractValidator<UpdateDeliveryMethodRequest>
{
    public UpdateDeliveryMethodRequestValidator()
    {
        //RuleFor(x => x.MethodId).NotNull().NotEmpty().WithMessage("Method Id cannot be empty or null")
        //    .GreaterThan(0).WithMessage("Method Id must be greater than 0");
