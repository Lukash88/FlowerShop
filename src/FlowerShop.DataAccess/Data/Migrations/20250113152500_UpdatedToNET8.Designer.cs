...
namespace FlowerShop.DataAccess.Data.Migrations
{
    ...
    [Migration("20250113152500_UpdatedToNET8")]
    partial class UpdatedToNET8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlowerShop.DataAccess.Core.Entities.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("FlowerShop.DataAccess.Core.Entities.OrderAggregate.ShippingAddress", "ShipToShippingAddress", b1 =>
                        {
                    ...
                    b.Navigation("ShipToShippingAddress")
                        .IsRequired();
                });
